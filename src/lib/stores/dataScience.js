...
const dataScience = readable([
  {
    ...
    description2:
      'This will mean we can massively ramp up the speed of data collection as we find new data sources. <a href="https://github.com/climatepolicyradar" target="_blank">Access our GitHub page for more information</a>.',
    icon: 'text',
  },
  {
