...
<Panel>
  <span slot="heading">Why</span>
  <div slot="copy">
    <p>
      Countless policy decisions have to be made by policymakers in our collective drive to net zero
      by mid-century.
    </p>
    <p>But how are those decisions informed?</p>
  </div>
  <div slot="aside">
    <IconList>
      <IconListItem
