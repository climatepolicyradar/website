    ...
    <IconList orientation="horizontal">
      <IconListItem orientation="vertical">
        ...
        <p class="u-type-body-md">
          A high impact and exciting mission at the intersection of technology,
          AI and policy. A chance to co-create and help us shape our journey ‒
          we are building our team and vision, so your input and impact will be
          significant.
        </p>
      </IconListItem>
      <IconListItem orientation="vertical">
        ...
        <p class="u-type-body-md">
          Access to a larger community of climate and data enthusiasts ‒ we are
          a member of Subak, an accelerator and cooperative for climate
          non-profit startups, and enjoy a joint programme of learning,
      ...
      <IconListItem orientation="vertical">
        ...
        <p class="u-type-body-md">
          A deep commitment to our employees’ mental and physical wellbeing.
          Among others we offer unlimited leave, flexible work hours, a generous
          wellbeing allowance, short Fridays, and great coffee. Hybrid work
          arrangement: stunning work space overlooking Westminster Bridge,
